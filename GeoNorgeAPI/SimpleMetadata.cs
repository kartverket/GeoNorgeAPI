...
namespace GeoNorgeAPI
{
    ...
    public class SimpleMetadata
    {
        ...
        private const string APPLICATION_PROFILE_SURVEY_AREA_MAP_WMS = "fullstendighetsdekningskart wms";
        ...
        private const string ENGLISH_APPLICATION_PROFILE_SURVEY_AREA_MAP_WMS = "survey area map wms";
        ...
        public string CoverageUrl
        {
            ...
            set
            {
                ...
                if (MetadataLanguage == METADATA_LANG_NOR)
                    ...
                    onlineResource.name = CreateFreeTextElementNorwegian(ENGLISH_APPLICATION_PROFILE_COVERAGE, APPLICATION_PROFILE_COVERAGE);
                onlineResource.protocol = new CharacterString_PropertyType { CharacterString = RESOURCE_PROTOCOL_WWW };
            }
        }
        ...
        public string CoverageGridUrl
        {
            ...
            set
            {
                ...
                if (MetadataLanguage == METADATA_LANG_NOR)
                    ...
                    onlineResource.name = CreateFreeTextElementNorwegian(ENGLISH_APPLICATION_PROFILE_COVERAGE_GRID, APPLICATION_PROFILE_COVERAGE_GRID);
                onlineResource.protocol = new CharacterString_PropertyType { CharacterString = RESOURCE_PROTOCOL_WWW };
            }
        }
        ...
        public string SurveyAreaMapUrlWms
        {
            get
            {
                return GetMetadataExtensionInfoURLWithApplicationProfile(APPLICATION_PROFILE_SURVEY_AREA_MAP_WMS);
            }
            set
            {
                CI_OnlineResource_Type onlineResource = GetMetadataExtensionInfoWithApplicationProfile(APPLICATION_PROFILE_SURVEY_AREA_MAP_WMS);
                if (onlineResource == null)
                {
                    onlineResource = new CI_OnlineResource_Type();
                    AddOnlineResourceToMetadataExtensionInfo(onlineResource);
                ...
                onlineResource.linkage = new URL_PropertyType { URL = value };
                onlineResource.applicationProfile = new CharacterString_PropertyType { CharacterString = APPLICATION_PROFILE_SURVEY_AREA_MAP_WMS };
                if (MetadataLanguage == METADATA_LANG_NOR)
                    onlineResource.name = CreateFreeTextElement(APPLICATION_PROFILE_SURVEY_AREA_MAP_WMS, ENGLISH_APPLICATION_PROFILE_SURVEY_AREA_MAP_WMS);
                else
                    onlineResource.name = CreateFreeTextElementNorwegian(ENGLISH_APPLICATION_PROFILE_SURVEY_AREA_MAP_WMS, APPLICATION_PROFILE_SURVEY_AREA_MAP_WMS);
                onlineResource.protocol = new CharacterString_PropertyType { CharacterString = RESOURCE_PROTOCOL_WWW };
            }
        }
        ...
        public string HelpUrl
        {
            ...
            set
            {
                ...
                if (MetadataLanguage == METADATA_LANG_NOR)
                    ...
                    onlineResource.name = CreateFreeTextElementNorwegian(ENGLISH_APPLICATION_PROFILE_HELP, APPLICATION_PROFILE_HELP);
                onlineResource.protocol = new CharacterString_PropertyType { CharacterString = RESOURCE_PROTOCOL_WWW };
            }
        }
        ...
        {
            return protocol == "W3C:REST" || protocol == "W3C:WS" || protocol == "OGC:WPS" || protocol == "OGC:SOS" || protocol == "OGC:API-Features"
